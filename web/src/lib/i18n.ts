...
export const UI = {
  ...
  nav: {
    ...
    explore: { zh: "探索", en: "Explore", ja: "探索へ" },
  ...
  search: {
    ...
    shortcut_title: { zh: "搜索 (Ctrl+K)", en: "Search (Ctrl+K)", ja: "検索 (Ctrl+K)" },
  ...
  gallery: {
    ...
    atmosphere_hint: {
      ...
      ja: "Open-Meteo ライブ · チップ上の都市座標（現在地ではありません）· ＋で5日",
    },
    ...
    weather_loading: { zh: "正在获取实况…", en: "Fetching live…", ja: "取得中…" },
    weather_unavailable: { zh: "实况暂不可用", en: "Live data unavailable", ja: "取得できません" },
    ...
    atlas_fx_trigger: { zh: "特效", en: "FX", ja: "エフェクト" },
    atlas_fx_aria: { zh: "播放特效", en: "Play FX", ja: "エフェクトを再生" },
    ...
    map_hint_title: {
      zh: "滚轮缩小可看全世界 · 拖动平移 · 双击重置",
      en: "Scroll to zoom out for full world · drag to pan · double-click to reset",
      ja: "スクロールで世界全図まで縮小 · ドラッグで移動 · ダブルクリックでリセット",
    },
    map_hint_sub: {
      zh: "滚轮缩放 · 拖动平移 · 光点进街景",
      en: "Scroll · drag · pin → street",
      ja: "スクロール · ドラッグ · ピンで街角へ",
    },
    map_crumb_aria: { zh: "地图层级", en: "Map level", ja: "マップ階層" },
    pagination_next: { zh: "下一页", en: "Next page", ja: "次のページ" },
    pagination_nav: { zh: "分页导航", en: "Gallery pages", ja: "ギャラリーページ" },
    map_load_error: {
      zh: "地图加载失败，请硬刷新 (Ctrl+Shift+R) 或重新运行 npm run dev",
      en: "Map failed to load. Hard refresh (Ctrl+Shift+R) or restart npm run dev.",
      ja: "マップの読み込みに失敗しました。強制再読み込み (Ctrl+Shift+R) または npm run dev を再起動してください。",
    },
    cluster_collapse: { zh: "→ 点击收起", en: "→ click to collapse", ja: "→ クリックで閉じる" },
    landing_select: { zh: "→ 单击选中 · 不放大", en: "→ click to select · no zoom", ja: "→ クリックで選択 · 拡大なし" },
    tooltip_street_default: { zh: "街景", en: "Street view", ja: "街角" },
  },
  settings: {
    ...
    theme_toggle: { zh: "切换外观", en: "Toggle theme", ja: "表示を切り替え" },
    theme_toggle_shortcut: {
      zh: "切换外观 (Ctrl+Shift+L)",
      en: "Toggle theme (Ctrl+Shift+L)",
      ja: "表示切替 (Ctrl+Shift+L)",
    },
    theme_unavailable: {
      zh: "外观切换暂不可用",
      en: "Theme switch temporarily unavailable",
      ja: "表示切替は一時的に利用できません",
    },
  },
  common: {
